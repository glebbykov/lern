...
## Задание 1. Анатомия файлового дескриптора
...
## Задание 2. Жизненный цикл процесса
...
## Задание 4. Карта процессов текущей сессии
...
## Задание 5. Файловые дескрипторы и перенаправления
...
## Задание 6. Сигналы: доставка, стандартные и realtime
...
## Задание 7. Удалённый файл и inode
...
## Задание 8. Демоны и double-fork
...
## Задание 9. /proc как интерфейс к ядру
...
## Задание 10. Зомби, сироты и усыновление
...
## Задание 11. nohup, disown, tmux: сравнение через fd
...
## Задание 12. Лимиты fd и стресс-тест
...
## Задание 14. Отладка: strace, lsof, gdb, ptrace
...
## Задание 15. Межпроцессное взаимодействие (IPC)
