...
graph LR
  ...
  V2 <-->|p23 / p32| V3["vnet-r3<br/>10.12.0.0/16"]
```

**Full Mesh:** Все регионы соединены напрямую. Пакеты идут кратчайшим путем.

> **✅ Архитектурное решение реализовано:** см. [ADR-0006](adr/0006-r2-r3-peering.md).
